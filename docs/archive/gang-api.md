> **⚠️ ARCHIVED 2026-07-22 — superseded by [`docs/gang-engine.md`](../gang-engine.md) (§3, "Gang
> API & mechanics reference").** Kept here verbatim for history; the live copy has since picked up
> Phase 29's two additional measured facts and the resolved-questions framing. Don't edit this
> file going forward — edit the engine doc.
