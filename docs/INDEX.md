...
| Reset/augment-install bootstrap: faction-unlock sequence, backdoor→faction servers, Daedalus/Netburners gates, auto-unlock-not-join rule | [augment-install-protocol.md](augment-install-protocol.md) | After an augment install / new BitNode; anything about unlocking factions or the auto-backdoor task |
